...
contract_abi = [{'inputs': [{'internalType': 'contract RoleStore',
                ...
                {'indexed': True,
                    ...
                    'name': 'eventNameHash',
                    'type': 'string'},
                {'components': [{'components': [{'components': [{'internalType': 'string',
                        'name': 'key',
                        'type': 'string'},
                    ...
                    'name': 'addressItems',
                    'type': 'tuple'},
                    {'components': [{'components': [{'internalType': 'string',
                        'name': 'key',
                        'type': 'string'},
                ...
                'name': 'EventLog2',
                'type': 'event'},
                {'inputs': [{'internalType': 'bytes32', 'name': 'topic1', 'type': 'bytes32'},
                ...
                {'inputs': [],
                'name': 'roleStore',
                'outputs': [{'internalType': 'contract RoleStore',
                    'name': '',
                    'type': 'address'}],
